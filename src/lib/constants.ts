...
import { ComponentGroup, ContentItem, LayoutGroup } from "./types";
...
export const CreatePageCard = [
  {
    ...
    description : 'Write a prompt ad leave everything else for us to handle ',
    type : 'template',
  },
  {
    title: 'Generate with' ,
...
// chatgpt.ts mdhl ahe 
 ...
 export const findImageComponents =  (layout : ContentItem) : ContentItem[]=> {
    const images = []
